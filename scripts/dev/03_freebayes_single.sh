...
#SBATCH --output=/faststorage/project/EcoGenetics/people/Jeppe_Bayer/data/temp/out/freebayes-2-%j.out
...
-v /faststorage/project/EcoGenetics/people/Jeppe_Bayer/data/temp/Ocin_NYS-F_02.vcf \
--pooled-discrete \
/faststorage/project/EcoGenetics/people/Jeppe_Bayer/data/temp/Ocin_NYS-F_02.bam