...
Usage: 01_repeatmm_00_ini.sh -r <FILE> [OPTIONS]
...
job1(){
    jobidlist[1]=$(sbatch \
                ...
                "$script_path"/modules/01_repeatmm_01_database.sh "$reference_genome")
}
...
job2(){
    ...
    jobidlist[2]=$(sbatch \
                ...
                "$script_path"/modules/01_repeatmm_02_model.sh "$reference_genome")
}
...
job3(){
    jobidlist[3]=$(sbatch \
                ...
                "$script_path"/modules/01_repeatmm_03_mask_repbase.sh "$reference_genome" "$repbaserun" "$repmodrun" "$repmod")
}
...
job4(){
    jobidlist[4]=$(sbatch \
                ...
                "$script_path"/modules/01_repeatmm_04_mask_repmod.sh "$reference_genome" "$repbaserun" "$repmodrun" "$repmod")
}
...
job5(){
    jobidlist[5]=$(sbatch \
                ...
                "$script_path"/modules/01_repeatmm_05_combine_process.sh "$reference_genome" "$repbaserun" "$repmodrun")
}
...
job6(){
    jobidlist[6]=$(sbatch \
                ...
                "$script_path"/modules/01_repeatmm_06_maskfasta.sh "$reference_genome" "$repmask")
}
