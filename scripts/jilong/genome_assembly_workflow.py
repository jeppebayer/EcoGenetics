...
def assemble_3ddna(folder,species,fasta,merged,r):
    ...
    spec = """
    cd {folder}
    /home/jilong/spider2/faststorage/social_spiders_2020/people/jilong/scripts/3d_dna/3d-dna/run-asm-pipeline.sh \
        -r {r} \
        --editor-repeat-coverage 30 \
        --editor-coarse-stringency 20 \
        {fasta} \
        {merged} \
        > {folder}/{species}_3ddna.log.tmp
